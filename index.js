...
var _ztsu$health_checker$Main$viewGroup = F2(
	function (probes, name) {
		...
		var probe = function (probe) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('probe')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('probe-name')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(probe.name)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('probe-status')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('probes')
							]),
						A2(_elm_lang$core$List$map, probe, probes))
					]));
		};
		var childs = _elm_lang$core$Basics$not(
			_elm_lang$core$Native_Utils.eq(name, '')) ? _elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$h2,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('group-name')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _ztsu$health_checker$Main$Flags = function (a) {
	return {manifestUrl: a};
};
var _ztsu$health_checker$Main$TouchProbeError = F2(
	function (a, b) {
		return {ctor: 'TouchProbeError', _0: a, _1: b};
	});
var _ztsu$health_checker$Main$TouchProbeResult = F2(
	function (a, b) {
			...
			case 'ReceiveProbesError':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							errors: A2(_elm_lang$core$List_ops['::'], 'Ошибка при получении манифест-файла', model.errors)
						}),
...
var _ztsu$health_checker$Main$ReceiveProbesError = function (a) {
...
var _ztsu$health_checker$Main$init = function (flags) {
	...
	if (_p18.ctor === 'Just') {
		return {
			ctor: '_Tuple2',
			_0: A3(
				_ztsu$health_checker$Main$Model,
				flags.manifestUrl,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
		...
		return {
			...
			_0: A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					['Не указан url до манифест-файла'])),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	}
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ztsu$health_checker$Main$main === 'undefined' ? null : _ztsu$health_checker$Main$main);
